...
#ifndef EXAMPLEANDTIMINGI2C_H_
#define EXAMPLEANDTIMINGI2C_H_
...
#include "beaglebone_blacklib/BlackI2C.h"
#include <string>
#include <iostream>
...
void exampleAndTiming_I2C()
{

    Timing i2cTiming;

    i2cTiming.startMeasure("1. Constructor");
    BlackLib::BlackI2C  myI2c(BlackLib::I2C_1, 0x53);
    i2cTiming.endMeasure("1. Constructor");


    i2cTiming.startMeasure("2. BlackI2C::open()");
    bool isOpened = myI2c.open( BlackLib::ReadWrite | BlackLib::NonBlock );
    i2cTiming.endMeasure("2. BlackI2C::open()");
    ...
    i2cTiming.startMeasure("3.1. BlackI2C::readByte()");
    uint8_t powerCtlReg     = myI2c.readByte(powerCtl_Addr);
    i2cTiming.endMeasure("3.1. BlackI2C::readByte()");
    ...
    i2cTiming.startMeasure("3.2. BlackI2C::writeByte()");
    bool resultOfWrite      = myI2c.writeByte(powerCtl_Addr, powerCtlReg);
    i2cTiming.endMeasure("3.2. BlackI2C::writeByte()");
    ...
    i2cTiming.startMeasure("4.1. BlackI2C::readWord()");
    int16_t tempRead        = myI2c.readWord(offsetX_Addr);
    i2cTiming.endMeasure("4.1. BlackI2C::readWord()");
    ...
    i2cTiming.startMeasure("4.2. BlackI2C::writeWord()");
    resultOfWrite           = myI2c.writeWord(offsetX_Addr, tempWrite);
    i2cTiming.endMeasure("4.2. BlackI2C::writeWord()");
    ...
    i2cTiming.startMeasure("5.1. (Block Size:3) BlackI2C::readBlock()");
    uint8_t readBlockSize       = myI2c.readBlock(offsetX_Addr, offsetValues, sizeof(offsetValues) );
    i2cTiming.endMeasure("5.1. (Block Size:3) BlackI2C::readBlock()");
    ...
    i2cTiming.startMeasure("5.2. (Block Size:3) BlackI2C::writeBlock()");
    resultOfWrite               = myI2c.writeBlock(offsetX_Addr, offsetValues, sizeof(offsetValues) );
    i2cTiming.endMeasure("5.2. (Block Size:3) BlackI2C::writeBlock()");
    ...
    i2cTiming.startMeasure("6.1. (Block Size:3) BlackI2C::readLine()");
    myI2c.readLine( offsetValues2, sizeof(offsetValues2) );   // read three data from "offsetX_Addr"
    i2cTiming.endMeasure("6.1. (Block Size:3) BlackI2C::readLine()");
    ...
    i2cTiming.startMeasure("6.2. (Block Size:3) BlackI2C::writeLine()");
    resultOfWrite               = myI2c.writeLine(tempBufWithAddr, sizeof(tempBufWithAddr) );
    i2cTiming.endMeasure("6.2. (Block Size:3) BlackI2C::writeLine()");
    ...
    std::cout << i2cTiming.getAllMeasureTable();
    i2cTiming.saveToFile("BlackI2C_timing_results.out");
